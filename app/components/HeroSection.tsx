...
function HeroSection(){
    ...
    <div className="flex  flex-col justify-end h-full pb-[55px] md:py-[55px] font-(family-name:--font-raleway) gap-1">
            ...
            <h6 className="text-base font-medium   pb-[2px] ">Front-End Developer specializing in React.js, Tailwind CSS & GitHub Actions. Crafting seamless UI experiences with scalable solutions.</h6>
            <div className="flex flex-row gap-3 ">
                <Button isPrimary className="max-w-[166px] w-full leading-tight" iconName={"person.svg"}>About Me</Button >
                <Button isOutLine className="max-w-[166px] w-full leading-tight" iconName={"Eye.svg"}>Projects</Button >
            </div>
