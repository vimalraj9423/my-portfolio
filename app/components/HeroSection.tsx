...
function HeroSection() {
  return (
    <div className="flex flex-col-reverse md:flex-row h-[var(--hero-section)] px-10 md:px-20 py-10 md:py-14 gap-10">
      <div className="md:flex-1">
        <div className="flex  flex-col justify-end h-full md:py-[55px] font-(family-name:--font-raleway) gap-1">
          ...
          <h6 className="text-base font-medium   pb-[2px] ">
            Front-End Developer specializing in React.js, Tailwind CSS & GitHub
            Actions. Crafting seamless UI experiences with scalable solutions.
          </h6>
