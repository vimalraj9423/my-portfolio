...
function ServiceCard({ children, iconName }: ServiceCardProps) {
  return (
    <div className=" w-full  h-56 px-3 py-5 hover:bg-[var(--hover-grey)] bg-linear-[350deg,var(--color-button-from),var(--color-button-to)] inline-flex flex-col justify-end items-start gap-2.5 overflow-hidden">
