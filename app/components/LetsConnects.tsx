  ...
  return (
    <div className="bg-[#FFFDFC]">
      <div className="max-w-[1440px] mx-auto  px-9  ">
        <div className="flex flex-col md:flex-row mx-auto transform p-[88px] pt-[100px] rounded-lg drop-shadow-[0_59px_124px_rgba(0,0,0,0.2)] bg-white translate-y-[100px] gap-[126px]">
